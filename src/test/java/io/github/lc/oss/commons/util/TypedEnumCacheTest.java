...
public class TypedEnumCacheTest extends AbstractMockTest {
    ...
    public void test_caseSensitive() {
        ...
        try {
            ...
            Assertions.assertEquals("No enum constant io.github.lc.oss.commons.util.TypedEnumCacheTest.TestEnum.null", ex.getMessage());
        }
        ...
        try {
            ...
            Assertions.assertEquals("No enum constant io.github.lc.oss.commons.util.TypedEnumCacheTest.TestEnum.a", ex.getMessage());
        }
        ...
        try {
            ...
            Assertions.assertEquals("No enum constant io.github.lc.oss.commons.util.TypedEnumCacheTest.TestEnum.B", ex.getMessage());
        }
    }
